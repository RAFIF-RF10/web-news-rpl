        ...
        {activeTab === 'profile' && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600 mt-1">Perbarui foto profil dan informasi pribadi Anda</p>
            </div>
            ...
            <form onSubmit={handleProfileSubmit} className="p-6">
              ...
              <div className="flex items-start gap-6 mb-8">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Foto Profil</h3>
              ...
              <div className="mt-8 flex justify-end gap-4">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-blue-600 text-white rounded-lg font-medium shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:bg-blue-400 disabled:cursor-not-allowed inline-flex items-center"
                >
                  {actionLoading && (
        ...
        {activeTab === 'security' && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600 mt-1">Perbarui password untuk menjaga keamanan akun Anda</p>
            </div>
            ...
            <form onSubmit={handlePwSubmit} className="p-6">
              <div className="max-w-md space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-gray-900 mb-3">Syarat Password:</h4>
                  <ul className="text-xs text-gray-600 space-y-1">
                    <li className="flex items-center gap-2">
                      <span className={`w-2 h-2 rounded-full ${pwForm.new_password?.length >= 8 ? 'bg-green-500' : 'bg-gray-300'}`}></span>
                      Minimal 8 karakter
                    </li>
                    <li className="flex items-center gap-2">
                      <span className={`w-2 h-2 rounded-full ${/[a-z]/.test(pwForm.new_password) ? 'bg-green-500' : 'bg-gray-300'}`}></span>
                      Huruf kecil (a-z)
                    </li>
                    <li className="flex items-center gap-2">
                      <span className={`w-2 h-2 rounded-full ${/[A-Z]/.test(pwForm.new_password) ? 'bg-green-500' : 'bg-gray-300'}`}></span>
                    ...
                    <li className="flex items-center gap-2">
                      <span className={`w-2 h-2 rounded-full ${/\d/.test(pwForm.new_password) ? 'bg-green-500' : 'bg-gray-300'}`}></span>
                      Angka (0-9)
                    </li>
                    <li className="flex items-center gap-2">
                      <span className={`w-2 h-2 rounded-full ${/[!@#$%^&*(),.?":{}|<>]/.test(pwForm.new_password) ? 'bg-green-500' : 'bg-gray-300'}`}></span>
                      Karakter khusus (!@#$%^&*)
                    </li>
                  </ul>
                </div>
                ...
                <div className="flex justify-end gap-4 pt-4">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-green-600 text-white rounded-lg font-medium shadow hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed inline-flex items-center"
                  >
                    {actionLoading && (
                      <svg className="animate-spin -ml-1 mr-3 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24">
                        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
